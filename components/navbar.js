        ...
        <div className="container mx-auto px-6 pt-2 pb-2 flex justify-around items-center">
          ...
          <Link href="/">
            <div className="flex flex-col items-center text-xs text-black mx-2">
              ...
              <span className={`mt-0 pt-0 ${currentPage === 'inicio' ? "font-bold" : ""}`}>Inicio</span>
            </div>
          </Link>
          ...
          <Link href="/mapa">
            <div className="flex flex-col items-center text-xs text-black mx-16">
              ...
              <span className={`mt-0 pt-0 ${currentPage === 'mapa' ? "font-bold" : ""}`}>Mapa</span>
            </div>
          </Link>
          ...
          <Link href="/datos">
            <div className="flex flex-col items-center text-xs text-black mx-2">
              ...
              <span className={`mt-0 pt-0 ${currentPage === 'datos' ? "font-bold" : ""}`}>Datos</span>
            </div>
          </Link>
