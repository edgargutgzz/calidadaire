...
function Navbar({ currentPage }) {
  return (
    <nav className="bg-white z-10 fixed w-full bottom-0 flex-col lg:z-auto lg:w-2/12 lg:h-screen lg:static lg:flex lg:flex-col">
      <div className="container mx-auto px-8 pt-3 pb-2 flex justify-around items-center h-full lg:flex-col lg:justify-center lg:items-start lg:space-y-20 lg:py-16">
        
        {/* Home */}
        <Link href="/">
          <div className="flex flex-col items-center text-xs  text-black lg:flex-row lg:text-base lg:mb-8 lg:ml-4">
        ...
        {/* Mapa */}
        <Link href="/mapa">
          <div className="flex flex-col lg:flex-row items-center text-xs lg:text-base text-black lg:mb-8 lg:ml-4">
